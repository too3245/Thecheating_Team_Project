					...
					<form action="upWrite.do" >
						...
						<br/><br/>
							...
							<tr>
								...
								<td>
									<input type="text" name="up_title" required="required" >
								</td>
							</tr>
							<tr>
								<td align="right" >
								...
								<td>
									<input type="text"  name="up_author" rows="5" cols="30" required="required" >
								</td>
							</tr>
							<tr>
								<td align="right" >
								...
								<td>
									<textarea style="resize: none;" name="up_content" rows="5" cols="60"  required="required" ></textarea>
								</td>
							</tr>
							<tr>
								<td align="center" >
