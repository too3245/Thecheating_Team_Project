...
<head>
    ...
    <title>문의사항 답글 상세보기 - 수정, 삭제</title>
</head>
<body>
<header>
            ...
            <div class="container">
                <div class="row mainArticle">
                    <div class="col-xl-12 p-5">    
						<form action="contactReplyUpdate.do">
							<table align="center">
							<tbody>
							<br/><br/>
								<tr>
								...
								<tr>
									...
									<td>
										<input type="text" name="contact_title" value="<%= re_contact_title %>" readonly="readonly" />
									</td>
								</tr>
								<tr>
									<td align="right" >
									...
									<td>
										<textarea style="resize: none;" name="contact_content" rows="5" cols="60"><%= re_contact_content %></textarea>
									</td>
								</tr>
								<tr>
									<td colspan="3" align="center" >
										<input type="submit" class="w3-button w3-black w3-round"  value = "수정완료" style="font-size:1em; font-color: white;">
										<button type="button" class="w3-button w3-black w3-round" style="font-size:1em; font-color: white;" onclick="location.href='contactDelete.do?re_contact_idx=<%= re_contact_idx %>'">삭제</button>
