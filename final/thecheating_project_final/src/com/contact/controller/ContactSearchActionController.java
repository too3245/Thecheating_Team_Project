...
public class ContactSearchActionController implements Controller {
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		System.out.println("Contact Search Action Controller 실행됨!");
        ...
        mav.setViewName("contact/contactList"); // 문의사항 글목록 화면으로 이동
