...
public class EventSearchActionController implements Controller {
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		System.out.println("EVENT Search Action Controller 실행됨!");
        ...
        mav.setViewName("event/eventList"); // 이벤트 글목록 화면으로 이동
